	    ...
	    <script>
		   ...
		   $(function(){
			   ...
			   $("#search").click(function() {
				   ...
				   console.log(keyword);
				   location.href="beautysearch.do?keyword=" + encodeURI(encodeURIComponent(keyword));
        ...
        <div class="col-lg-12 text-center">
			...
			<table class="table">
				<tr>
					...
					<td></td>
					<td>
						<form class="example" action="/beautysearch.do" method="POST"  >
					...
					<td>
						<a href="beautyregister.do"><input type="button" value="등록"></a>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3"><a href="/beautydetail.do?beautySeqNo=<%=b.getBeautySeqNo() %>"><%=b.getTitle() %></a></td>
					<td><%=b.getUserName() %></td>
					<td><%=b.getChgDt() %></td>
				</tr>
				<% } %>
