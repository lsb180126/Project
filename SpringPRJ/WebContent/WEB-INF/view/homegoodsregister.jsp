...
<html>
	...
	<div class="container">
      <div class="row">
        ...
        <form action="/homegoodslist.do" method="POST" enctype="multipart/form-data" id="f1">
			...
			<table class="table">
				<tr>
					...
					<td>
						<input type="button" class="btn btn-outline-primary" value="등록" id="hi">
					</td>
					<td>
						<a href="homegoods.do"><input class="btn btn-outline-primary" type="button" value="목록"></a>
					</td>
				</tr>
