	...
	<div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
        	...
        	<form action="/eatrevise2.do" method="POST" enctype="multipart/form-data">
			...
			<table class="table">
				...
				<%-- <img src="/upload/<%=eDTO.getChgName()%>" height="200" width="200" id="chgName"> --%>
					<input type="file" name="file" id="file" >
					<input type="hidden" value="eat" name="kind">
					<input type="hidden" value="<%=eDTO.getOriName()%>" name="oriName">
					<input type="hidden" value="<%=eDTO.getFileSize()%>" name="fileSize">
					<input type="hidden" value="<%=eDTO.getFileSeq()%>" name="fileSeq">
				    <input type="hidden" value="<%=eDTO.getChgName()%>" name="chgName">
				    <input type="hidden" value="<%=eDTO.getFilePath()%>" name="path">
				    <input type="hidden" value="<%=eDTO.getExtension()%>" name="extension"> 
				</form>
