	...
	<head>
	    ...
	    <script>
		   ...
		   $(function(){
			   ...
			   $("#search").click(function() {
				   ...
				   console.log(keyword);
				   location.href="userlist.do?keyword=" + keyword;
	   ...
	   <script type="text/javascript">
		...
		function goPage(page){
			...
			location.href="/userlist.do?pageCount="+pageCount+"&pageNum="+page +"&keyword="+"<%=keyword%>";
		}
        ...
        <div class="col-lg-12 text-center">
			...
			<table class="table table-hover">
				<tr>
					...
					<th scope="row" colspan="2">회원 정보</th>
					<td>
					...
					<td>
						<form class="example" action="/userlist.do" method="POST">
				...
				<tr>
					...
					<td colspan="2"><a href="/userdetail.do?userSeqNo=<%=u.getUserSeqNo()%>&pageCount=<%=paging.getPage_count()%>&pageNum=<%=paging.getPage_num()%>&keyword=<%=keyword%>"><%=u.getUserId() %></a></td>
