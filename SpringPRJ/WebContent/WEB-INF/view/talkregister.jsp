...
<html>
	...
	<div class="container">
      <div class="row">
        ...
        <form action="/talklist.do" method="POST" enctype="multipart/form-data" id="f1">
			...
			<table class="table">
				<tr>
					...
					<td>
						<a href="talk.do"><input class="btn btn-outline-primary" type="button" value="목록"></a>
					</td>
				</tr>
					...
					<tr>
				     ...
				     <tr>
				     	<td colspan="6">
				     		<textarea class="form-control"  rows="20" cols="100" maxlength="1000" placeholder="내용을 입력해 주세요." id="content" name="content"></textarea>
				     	</td>
			     	</tr>
			     	<tr>
			     		<td></td>
