        ...
        <div class="col-lg-12 text-center">
			...
			<table class="table table-hover">
				<tr>
					...
					<th scope="row" colspan="2">미용 정보</th>
					<td>
					...
					<td>
						<a href="beautyregister.do"><input class="btn btn-outline-primary" type="button" value="등록"></a>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3"><a href="/beautydetail.do?beautySeqNo=<%=b.getBeautySeqNo() %>&pageCount=<%=paging.getPage_count()%>&pageNum=<%=paging.getPage_num()%>&keyword=<%=keyword%>"><%=b.getTitle() %></a></td>
					<td><%=b.getUserName() %></td>
					<td><%=b.getChgDt() %></td>
				</tr>
				<% } %>
